      ...
      <div className='w-[30rem] bg-white p-5 rounded-lg'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='flex items-center justify-between pt-5'>
            ...
            <button disabled={activateSubmit} type="submit" className={`bg-gray-200 text-gray-400 px-16 py-2 rounded-md ${activateSubmit && "bg-blue-600 text-white"}`}>Close Account</button>
          </div>
        </form>
      </div>
    </div>
